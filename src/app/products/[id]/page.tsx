...
export default function ProductId({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full mt-10 mb-10">
      <Link href={"/products"}>
      ...
      <div className="flex flex-col items-center max-w-2xl rounded-md shadow-xl mt-7 border-zinc-10 shadow-lg0">
        <div className="p-7">
        ...
        <button
          ...
          className="self-center w-5/6 px-4 py-2 mt-5 mb-5 text-white rounded-md mb-2font-semibold bg-slate-800"
        >
          Add to Cart
        </button>
      </div>
